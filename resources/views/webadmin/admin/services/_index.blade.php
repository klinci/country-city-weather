...
<script type="text/javascript">
  var table = jQuery('._table').DataTable({
    ...
    buttons : [
      {
        ...
        action  : function()
        {
          ...
          jQuery.get('{{route("services.create")}}',function(res){
      ...
      },
      {
        ...
        action  : function(e, dt, node, config)
        {
          ...
          if(res != undefined ) {
            var _url = replaceUrlId('{{ route("services.edit","ID") }}',res.id);
      ...
      },
      {
        ...
        action  : function(e, dt, node, config)
        {
          ...
          jQuery('.modal-body').html(errorAlert("Silakan pilih data terlebih dahulu."));
          if(res != undefined ) {
            var _url = replaceUrlId('{{ route("services.show","ID") }}',res.id);
    ...
    columns : [
      ...
      { data : 'domain', name : 'domain', className : 'text-center' },
