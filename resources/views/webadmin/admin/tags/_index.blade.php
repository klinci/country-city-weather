    ...
    buttons : [
        {
            ...
            action  : function()
            {
                ...
                jQuery.get('{{ route("tags.create") }}', function(res) {
        ...
        },
        {
            ...
            action  : function(e, dt, node, config)
            {
                ...
                if(res != undefined ) {
                    var _url = replaceUrlId('{{ route("tags.edit","ID") }}',res.id);
        ...
        },
        {
            ...
            action  : function(e, dt, node, config)
            {
                ...
                jQuery('.modal-body').html(errorAlert("Silakan pilih data terlebih dahulu."));
                if(res != undefined ) {
                    var _url = replaceUrlId('{{ route("tags.show","ID") }}',res.id);
